    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#about" class="text-gray-400 hover:text-white transition">About Diplomas</a></li>
          <li><a href="#courses" class="text-gray-400 hover:text-white transition">Our Courses</a></li>
          <li><a href="#eligibility" class="text-gray-400 hover:text-white transition">Eligibility</a></li>
          <li><a href="#process" class="text-gray-400 hover:text-white transition">Admission Process</a></li>
...
402, Siddheshwar Palace 10, Mill Rd, <br/>Nawada, Ara, India 802301</span>
    ...
    <div class="pt-6 border-t border-gray-800 text-center">
      <p class="text-gray-500 text-sm">
        © 2025 Diploma Courses. All rights reserved. Design and Developed by 
        <a href="https://digitalsuccesssolutions.in/" style="color: orange;" target="_blank" class="text-primary hover:underline">Digital Success Solutions 🚀</a>
      </p>
    </div>
  </div>
</footer>
